...
def append_objs_to_img(cv2_im, objs, labels,bbox_only=False):
    ...
    for obj in objs:
        ...
        if bbox_only==False: cv2_im = cv2.putText(cv2_im, label, (x0, y0+30),cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255, 0, 0), 2)
    return cv2_im
