...
if __name__ == '__main__':
    ...
    for i, c in enumerate(contours):
        ...
        angle = getOrientation(c, imgContour)
        #print("angle: ",angle)
    imgStack = stackImages(0.6,([image,imgGray,imgBlur],
                                [imgCanny,imgContour,imgZero]))
    #shows picture in 6 edited wais
    # cv.imshow("Stacked Images Picture", imgStack)
    cv.imshow("Stacked Images Picture", imgContour)
    cv.waitKey(0)
