...
def calc_rotmat_to_align_vec_a_to_vec_b(vec_b, vec_a,hand="right",rot_dir=1,dash=True):
	...
	# for right handed system
		...
		print("delta [alpha,beta,gamma]-ist:  ",list(map(sub,[90.128,0.478,62.117],[alpha,beta,gamma])))
	elif hand=="left":
...
def main():
	...
	print("\n#####Testing right handed zyx ,dash=False#####")
	rot_mat=calc_rotmat_to_align_vec_a_to_vec_b(extracted_waypoints_rel[1], extracted_waypoints_rel[2],hand="right",dash=False)
	rot_rot_vec=list(R.from_matrix(rot_mat).as_euler("zyx",degrees=True))
	print("rot_rot_vec: ",rot_rot_vec)
	print("rot_rot_vec soll:",[90.128,0.478,62.117])
	print("delta soll-ist:  ",list(map(sub,[90.128,0.478,62.117],rot_rot_vec)))
	...
	###WINNER###
	print("\n#####Testing left handed zyx,dash=False#####")
	rot_mat=calc_rotmat_to_align_vec_a_to_vec_b(extracted_waypoints_rel[1], extracted_waypoints_rel[2],hand="left",dash=False)
	rot_rot_vec=list(R.from_matrix(rot_mat).as_euler("zyx",degrees=True))
	print("rot_rot_vec: ",rot_rot_vec)
	print("rot_rot_vec soll:",[90.128,0.478,62.117])
	print("delta soll-ist:  ",list(map(sub,[90.128,0.478,62.117],rot_rot_vec)))
	...
	# extracted_waypoints_rel[2][3:6]=rot_rot_vec
	#
	# print("\n#####Testing right handed xyz,dash=False#####")
	# rot_mat=calc_rotmat_to_align_vec_a_to_vec_b(extracted_waypoints_rel[1], extracted_waypoints_rel[2],hand="right",dash=False)
	# rot_rot_vec=list(R.from_matrix(rot_mat).as_euler("xyz",degrees=True))
	# print("rot_rot_vec: ",rot_rot_vec)
	# print("rot_rot_vec soll:",[90.128,0.478,62.117])
	...
	# extracted_waypoints_rel[2][3:6]=rot_rot_vec
	#
	# print("\n#####Testing left handed xyz,dash=False#####")
	# rot_mat=calc_rotmat_to_align_vec_a_to_vec_b(extracted_waypoints_rel[1], extracted_waypoints_rel[2],hand="left",dash=False)
	# rot_rot_vec=list(R.from_matrix(rot_mat).as_euler("xyz",degrees=True))
	# print("rot_rot_vec: ",rot_rot_vec)
	# print("rot_rot_vec soll:",[90.128,0.478,62.117])
